...
export declare const getCounter: () => ICounter;
export declare const getParameters: () => Partial<IParameters>;
export declare class SampleComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    /**
     * Empty constructor.
     */
    constructor();
